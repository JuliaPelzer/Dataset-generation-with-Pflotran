...
# save screenshot
SaveScreenshot(dir_vis +'V_field_vertical_cut_last_step.png', renderView1, ImageResolution=[2852, 1580])
...
# save screenshot
SaveScreenshot(dir_vis +'V_field_vertical_cut_first_step.png', renderView1, ImageResolution=[1424, 790])
...
# save screenshot
SaveScreenshot(dir_vis +'V_field_top_view_last_step.png', renderView1, ImageResolution=[1424, 790])